...
class TestCalculator(unittest.TestCase):
    ...
    def test_cal_cost_per_min(self):
        cal = Calculator()
        self.assertEqual(cal.cal_cost_per_min(
            350, 5, 1.1, 0.5), 0.16041666666666665)

    def test_cal_cost(self):
        cal = Calculator()
        self.assertEqual(cal.cal_cost(
            8, 50, "18:01", "2021-01-01", 350), 12.83333333333333)
        self.assertEqual(cal.cal_cost(
            8, 50, "18:00", "2021-01-01", 350), 14.437499999999996)
        self.assertEqual(cal.cal_cost(
            8, 50, "06:00", "2021-01-01",  350), 25.66666666666666)
        self.assertEqual(cal.cal_cost(
            8, 50, "05:59", "2021-01-01",  350), 24.062499999999993)
        self.assertEqual(cal.cal_cost(
            8, 50, "23:59", "2021-01-02",  350), 12.83333333333333)
    ...
    def test_solar_energy_aux(self):
        ...
        self.assertEqual(cal.solar_energy_aux("01-01-2020", "12:00", "3800", 80,
                         20, 80, 350), ([0.05966101694915255], ['12:00', '13:00'], '13:30'))
        self.assertEqual(cal.solar_energy_aux(
            "01-01-2020", "23:00", "3800", 80, 20, 80, 350), ([], [], '19:45'))

    def test_get_solar_energy(self):
        cal = Calculator()
        self.assertEqual(cal.get_solar_energy_duration(
            "3800", "01-01-2020", "12:00", 9), (90, '12:00', '13:30'))
        self.assertEqual(cal.get_solar_energy_duration(
            "3800", "01-01-2020", "12:59", 9), (90, '12:59', '14:29'))
        self.assertEqual(cal.get_solar_energy_duration(
            "3800", "01-01-2020", "18:00", 9), (90, '18:00', '19:30') )
        self.assertEqual(cal.get_solar_energy_duration(
            "3800", "01-01-2020", "13:00", 9),(90, '13:00', '14:30') )
